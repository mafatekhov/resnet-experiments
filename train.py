...
from utils import save_plots, get_data, save_model, save_torchscript_model


def train_model(model, model_filename, train_loader, test_loader, device, learning_rate=1e-1, num_epochs=20, plot_name='scratch'):
